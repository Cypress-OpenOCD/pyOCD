...
def flash_test(board_id):
    ...
    if {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xx7', 'id': '1900', 'name': 'CY8CKIT-062-WIFI-BT'}\
        in obj['boards'] and\
        {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xxA', 'id': '1901', 'name': 'CY8CPROTO-062-4343W'}\
        in obj['boards'] and\
        {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xx7', 'id': '1902', 'name': 'CY8CKIT-062-BLE'}\
        in obj['boards'] and\
        {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xxA', 'id': '1903', 'name': 'CY8CPROTO-062-43012'}\
        in obj['boards'] and\
        {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xx7', 'id': '1904', 'name': 'CY8CPROTO-063-BLE'}\
        in obj['boards'] and\
        {'binary': 'l1_cy8c6xx7.bin', 'target': 'cy8c6xxA', 'id': '1905', 'name': 'CY8CKIT-062-4343W'}\
        in obj['boards'] and\
